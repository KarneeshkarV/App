...
const PlaceOfBirthScreen = ({ navigation }) => {
  ...
  const handleNext = () => {
    ...
    Alert.alert('Success', 'Place of birth saved. KYC flow complete for now.');
    // Example: navigate back to a home screen or a summary screen
    // navigation.navigate('Home');
  };

  const handleSkip = () => {
    console.log('Skip place of birth');
    Alert.alert('Skipped', 'KYC flow complete for now.');
    // navigation.navigate('Home');
  };
